...
if is_available("codecompanion.nvim") then
  -- Define mappings for normal and visual modes
  maps.n["<leader>aa"] = {
  ...
  maps.v["<leader>ac"] = {
    "<cmd>CodeCompanionChat Toggle<cr>",
    desc = "Toggle CodeCompanion Chat (Visual Mode)",
  }
  ...
  maps.v["<leader>ad"] = {
    "<cmd>CodeCompanionChat Add<cr>",
    desc = "Add to CodeCompanion Chat (Visual Mode)",
  }
